...
public interface TransferenciaRepository extends JpaRepository<Transferencia, String> {
    ...
    @Query("""
    SELECT new com.ddo.torneios.dto.ResultadoLeilaoDTO(t.clube.nome, t.clube.imagem, t.jogador.nome, t.valorPago)
    FROM Transferencia t
    WHERE t.leilao.id = :leilaoId
    ORDER BY t.valorPago DESC
""")
    List<ResultadoLeilaoDTO> buscarResultadoProjetado(@Param("leilaoId") String leilaoId);
}